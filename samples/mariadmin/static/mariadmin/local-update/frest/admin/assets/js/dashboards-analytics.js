...
!(function () {
  ...
  var i = document.querySelectorAll(".chart-report"),
          ...
          var e = config.colors[o.dataset.color],
            ...
            e =
              ...
              (r = r),
              {
                ...
                colors: [e],
                grid: { padding: { top: -8, bottom: -10, left: -5, right: 0 } },
                series: [r],
                labels: ["Progress"],
              });
    ...
    l = {
      ...
      plotOptions: {
        bar: { columnWidth: "25%", borderRadius: 2, startingShape: "rounded" },
        distributed: !0,
      },
    ...
    l = {
      ...
      grid: { show: !1, padding: { top: 5, left: 10, right: 10, bottom: 5 } },
    ...
    l = {
      ...
      tooltip: { enabled: !1 },
      stroke: { curve: "smooth", width: 3 },
      grid: { show: !1, padding: { top: 10, left: 10, right: 10, bottom: 0 } },
    ...
    l = {
      chart: { height: 95, width: 155, type: "bar", toolbar: { show: !1 } },
      plotOptions: {
        bar: {
          barHeight: "80%",
          columnWidth: "50%",
      ...
      grid: { show: !1, padding: { top: -20, bottom: -20, left: 0, right: 0 } },
      colors: [
