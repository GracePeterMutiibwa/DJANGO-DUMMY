              ...
              return (function () {
                var e = {
                    ...
                    3331: function (e, t, n) {
                      ...
                      b(C, k),
                        b(L, A),
                        (e.exports = { ArrayBuffer: C, DataView: L });
                    },
                    1048: function (e, t, n) {
                      "use strict";
                      var r = n(7908),
                    ...
                    8264: function (e, t, n) {
                      ...
                      var r = n(2109),
                        ...
                        u = "ArrayBuffer",
                        s = o[u];
                      r({ global: !0, forced: i[u] !== s }, { ArrayBuffer: s }),
                        a(u);
                    },
                    2222: function (e, t, n) {
                      "use strict";
                        ...
                        { target: "Array", proto: !0, forced: !f },
                        {
                          slice: function (e, t) {
                            ...
                            if (
                              ...
                              return h.call(f, y, g);
                            for (
                              r = new (void 0 === n ? Array : n)(d(g - y, 0)),
                                c = 0;
                              y < g;
                              y++, c++
                            )
                        ...
                        return [
                          ...
                          function (e) {
                            ...
                            for (
                              ...
                              (p[h] = d),
                                "" === d &&
                                  (a.lastIndex = u(l, o(a.lastIndex), c)),
                                h++;
                            }
                            return 0 === h ? null : p;
                          },
                              ...
                              function (e, i) {
                                ...
                                for (var w = 0, E = 0, k = []; E < p.length; ) {
                                  ...
                                  if (
                                    ...
                                    if ((k.push(p.slice(w, E)), k.length === x))
                                      return k;
                                    for (var F = 1; F <= S.length - 1; F++)
                                      if ((k.push(S[F]), k.length === x))
                                        return k;
                                    E = w = A;
                                  }
                                }
                    ...
                    2056: function (e, t, n) {
                      ...
                      o("reverse", function () {
                        for (
                          var e, t = this, n = i(t).length, r = a(n / 2), o = 0;
                          o < r;
                  ...
                  (function () {
                    ...
                    var b = (function (e) {
                      ...
                      function i(e, t) {
                        ...
                        var u =
                          null != (a = i.optionsForElement(n.element)) ? a : {};
                        if (
                                ...
                                return this.listeners.map(function (e) {
                                  return (function () {
                                    ...
                                    for (var n in e.events) {
                                      var r = e.events[n];
                                      t.push(
                                        e.element.addEventListener(n, r, !1)
                                      );
                                    }
                                    return t;
                                  })();
                                ...
                                return this.listeners.map(function (e) {
                                  return (function () {
                                    ...
                                    for (var n in e.events) {
                                      var r = e.events[n];
                                      t.push(
                                        e.element.removeEventListener(n, r, !1)
                                      );
                                    }
                                    return t;
                                  })();
                                ...
                                if (e[0].upload.chunked) {
                                  ...
                                  for (
                                    ...
                                    r.upload.chunks[o] &&
                                      ...
                                      ((r.upload.progress +=
                                        r.upload.chunks[o].progress),
                                      (r.upload.total +=
                                        r.upload.chunks[o].total),
                                      (r.upload.bytesSent +=
                                        r.upload.chunks[o].bytesSent));
                                  (r.upload.progress =
                                    r.upload.progress /
        ...
        (t().autoDiscover = !1),
          (t().prototype.uploadFiles = function (e) {
            for (var n = this, r = 0; r < e.length; r++)
              for (
                var i = e[r],
                  o = Math.round(Math.min(60, Math.max(6, i.size / 1e5))),
                  a = 0;
                a < o;
                a++
              ) {
