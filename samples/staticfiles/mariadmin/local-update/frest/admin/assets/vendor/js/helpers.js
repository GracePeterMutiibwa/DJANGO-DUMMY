  ...
  return (function () {
    ...
    var h = {
      ...
      _findParent: function (t, e) {
        ...
        for (
          t = t.parentNode;
          t && "BODY" !== t.tagName.toUpperCase() && !t.classList.contains(e);
          ...
          this._menuMouseEnter ||
            ...
            this._windowTouchStart ||
              ((this._windowTouchStart = function (e) {
                (e && e.target && t._findParent(e.target, ".layout-menu")) ||
                  t._setMenuHoverState(!1);
              }),
      ...
      _unbindMenuMouseEvents: function () {
        if (
          ...
          this._menuMouseEnter &&
            (t &&
              (t.removeEventListener("mouseenter", this._menuMouseEnter, !1),
              t.removeEventListener("touchstart", this._menuMouseEnter, !1)),
            (this._menuMouseEnter = null)),
            this._menuMouseLeave &&
              (t &&
                t.removeEventListener("mouseleave", this._menuMouseLeave, !1),
      ...
      updateCustomOptionCheck: function (t) {
        t.checked
          ? ("radio" === t.type &&
              [].slice
                .call(t.closest(".row").querySelectorAll(".custom-option"))
                .map(function (t) {
