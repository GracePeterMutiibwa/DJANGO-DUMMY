...
document.addEventListener("DOMContentLoaded", function () {
  {
    ...
    o && new PerfectScrollbar(o, { wheelPropagation: !1, suppressScrollX: !0 }),
      ...
      p.addEventListener("submit", (e) => {
        ...
        // get the message
        let submittedMessage = v.value;

        // url
        let sendUrl = "http://127.0.0.1:8000/send/";
        ...
        fetch(sendUrl)
          .then((response) => {
            ...
            responseData.then((data) => {
              console.log(`Extracted data:${data["message"]}`);
              ...
              // bind the message
              messageContainer.innerHTML = '<p class="mb-0">' + v.value + "</p>";
